...
/**
 * 还不支持的表达式，则统一处理成UnSupportExpression，方便隐私规则校验以及tee不支持算子时的提示
 *
 * @singe 2020/9/8
 */
public class UnSupportExpression extends ExpressionBase {
    private final String name;

    public UnSupportExpression(List<Expression> operands, DataType dataType, String name) {
    ...
    public String simpleString(List<Attribute> inputAttributes) {
        return "UnSupportExpression=" + name;
    }
