...
public class OrExpression extends ExpressionBase {

    public OrExpression(List<Expression> expressionList, DataType dataType) {
    ...
    protected Expression copyWithNewChildren(List<Expression> children) {
        return new OrExpression(children, dataType);
    }
