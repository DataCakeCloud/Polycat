...
if [ ! -f "${SPARK_TAR}.tgz" ]; then
  wget https://mirrors.tuna.tsinghua.edu.cn/apache/spark/${SPARK}/${SPARK_TAR}.tgz
...
# copy denpendency
cp ../../../catalog/spark/target/polycat-spark-*.jar  ${SPARK_TAR}/jars
cp ../../../catalog/spark/target/lib/polycat-*.jar    ${SPARK_TAR}/jars
cp ../../../catalog/spark/target/lib/carbondata-*.jar ${SPARK_TAR}/jars
cp ../../../catalog/spark/target/lib/huaweicloud-*.jar ${SPARK_TAR}/jars
cp ../../../catalog/spark/target/lib/jackson-datatype-jdk8-*.jar ${SPARK_TAR}/jars
cp ../../../catalog/spark/target/lib/protobuf-java-*.jar ${SPARK_TAR}/jars
