...
@Data
public class GetDatabaseRequest extends DatabaseRequestBase<Void> {
    ...
    public GetDatabaseRequest(String projectId, String catName, String dbName) {
    ...
    public Operation getOperation() {
        return Operation.DESC_DATABASE;
    }
}
