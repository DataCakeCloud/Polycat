...
@Data
public class GetPrimaryKeysRequest extends TableRequestBase<Void> {

    public GetPrimaryKeysRequest(String projectId, String catalogName, String databaseName, String tableName) {
        super(projectId, catalogName, databaseName, tableName, null);
    }

    @Override
    public Operation getOperation() {
        return Operation.GET_PRIMARY_KEYS;
    }
}
