...
@ApiModel(description = "Binary Column stats")
@Data
public class BinaryColumnStatsData{
    @ApiModelProperty(value = "max column len", required = true)
    protected long maxColLen;

    @ApiModelProperty(value = "avg column len", required = true)
    protected double avgColLen; // required
