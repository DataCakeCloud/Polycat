...
public class GetTablePartitionsByNamesRequest extends TableRequestBase<PartitionFilterInput> {

    public GetTablePartitionsByNamesRequest() {

    }

    public GetTablePartitionsByNamesRequest(String projectId, String catalogName, String databaseName,
    ...
    public Map<String, String> getParams() {
        ...
        params.put(Constants.OPERATE_TYPE, "getPartitionsByNames");
        return params;
    }

    @Override
    public Operation getOperation() {
        return Operation.GET_PARTITIONS_BY_NAMES;
    }
}
