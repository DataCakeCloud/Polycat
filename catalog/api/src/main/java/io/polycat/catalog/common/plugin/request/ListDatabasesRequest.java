...
@Data
public class ListDatabasesRequest extends CatalogRequestBase<Void> {
    ...
    public ListDatabasesRequest(String projectId, String catName) {
    ...
    public Operation getOperation() {
        return Operation.SHOW_DATABASE;
    }
}
