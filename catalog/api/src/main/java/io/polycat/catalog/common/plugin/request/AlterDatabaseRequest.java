...
@Data
public class AlterDatabaseRequest extends DatabaseRequestBase<DatabaseInput> {
    public AlterDatabaseRequest() {
    }

    public AlterDatabaseRequest(String projectId, String catalogName, String databaseName, DatabaseInput input) {
        super(projectId, catalogName, databaseName, input);
    }

    @Override
    public Operation getOperation() {
        return Operation.ALTER_DATABASE;
    }
}
