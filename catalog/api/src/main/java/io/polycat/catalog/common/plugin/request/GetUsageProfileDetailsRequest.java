...
@Data
public class GetUsageProfileDetailsRequest extends CatalogRequestBase<Void> {
    ...
    public GetUsageProfileDetailsRequest(String projectId, TableSource tableSource) {
        this.projectId = projectId;
