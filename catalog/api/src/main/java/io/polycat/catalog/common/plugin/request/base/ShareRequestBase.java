...
@Data
public abstract class ShareRequestBase<T> extends ProjectRequestBase<T> {
    ...
    public ShareRequestBase(String projectId, String shareName, T input) {
        super(projectId, input);
        this.shareName = shareName;
    }

    public CatalogInnerObject getCatalogObject(CatalogContext context) {
        return new CatalogInnerObject(projectId, null, null, shareName);
    }
}
