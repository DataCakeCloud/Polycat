...
@ApiModel(description = "index name")
@Data
public class IndexName {
  ...
  public IndexName(String projectId, String catalogName, String databaseName, String indexName) {
