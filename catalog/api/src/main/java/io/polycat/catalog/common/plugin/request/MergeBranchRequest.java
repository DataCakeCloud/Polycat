...
@Data
public class MergeBranchRequest extends CatalogRequestBase<MergeBranchInput> {
    ...
    public void initContext(CatalogContext context) {
        ...
        if (input.getOwner() == null) {
            ...
            if (Objects.isNull(input.getDestBranchName())) {
                input.setDestBranchName(catalogName);
            } else {
                catalogName = input.getDestBranchName();
            }
        }
    }

    public Operation getOperation() {
        return Operation.MERGE_BRANCH;
    }
}
