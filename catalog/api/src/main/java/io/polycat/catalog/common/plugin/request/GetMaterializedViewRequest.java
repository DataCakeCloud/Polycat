...
@Data
public class GetMaterializedViewRequest extends DatabaseRequestBase<Void> {

  private final String materializedViewName;

  public GetMaterializedViewRequest(String projectId, String catalogName, String databaseName,
  ...
  public Operation getOperation() {
    return Operation.DESC_MATERIALIZED_VIEW;
  }
