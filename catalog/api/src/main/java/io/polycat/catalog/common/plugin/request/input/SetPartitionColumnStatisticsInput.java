...
@ApiModel(description = "set partition column statistics")
@Data
public class SetPartitionColumnStatisticsInput {

    @ApiModelProperty(value = "partition stats info list", required = true)
    List<ColumnStatistics> stats;

    @ApiModelProperty(value = "need merge into old statistics", required = true)
    boolean needMerge;
}
