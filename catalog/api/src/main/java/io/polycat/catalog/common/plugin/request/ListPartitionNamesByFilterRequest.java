...
public class ListPartitionNamesByFilterRequest extends TableRequestBase<PartitionFilterInput> {

    public ListPartitionNamesByFilterRequest() {

    }

    public ListPartitionNamesByFilterRequest(String projectId, String catalogName, String databaseName,
    ...
    public Map<String, String> getParams() {
        ...
        params.put(Constants.OPERATE_TYPE, "listByFilter");
        return params;
    }
