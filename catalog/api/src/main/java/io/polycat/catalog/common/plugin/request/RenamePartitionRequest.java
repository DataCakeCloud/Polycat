...
public class RenamePartitionRequest extends TableRequestBase<AlterPartitionInput> {
    public RenamePartitionRequest() {
    }

    public RenamePartitionRequest(String projectId, String catalogName, String databaseName, String tableName,
        AlterPartitionInput input) {
        super(projectId, catalogName, databaseName, tableName, input);
    }

    public Map<String, String> getParams() {
        Map<String, String> params = new HashMap<>();
        params.put(Constants.OPERATE_TYPE, "rename");
        return params;
    }

    @Override
    public Operation getOperation() {
        return Operation.RENAME_PARTITION;
    }
}
