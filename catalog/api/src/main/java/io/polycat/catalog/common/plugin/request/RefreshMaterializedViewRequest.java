...
@Data
public class RefreshMaterializedViewRequest extends DatabaseRequestBase<Void> {

  private final String materializedViewName;

  public RefreshMaterializedViewRequest(String catalogName, String databaseName,
  ...
  public Operation getOperation() {
    return Operation.REFRESH_MATERIALIZED_VIEW;
  }
}
