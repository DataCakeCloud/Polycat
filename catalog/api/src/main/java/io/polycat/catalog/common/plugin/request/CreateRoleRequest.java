...
@Data
public class CreateRoleRequest extends ProjectRequestBase<RoleInput> {

    @Override
    public void initContext(CatalogContext context) {
        super.initContext(context);
        if (input.getOwnerUser() == null) {
            input.setOwnerUser(context.getUserName());
        }
    }

    @Override
    public Operation getOperation() {
        return Operation.CREATE_ROLE;
    }
}
