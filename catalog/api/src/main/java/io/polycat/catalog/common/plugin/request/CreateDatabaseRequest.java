...
@Data
public class CreateDatabaseRequest extends CatalogRequestBase<DatabaseInput> {
    ...
    public void initContext(CatalogContext context) {
        ...
        if (input.getLocationUri() == null || input.getLocationUri().isEmpty()) {
            String databaseLocation =
                PathUtil.getDatabaseLocation(projectId, input.getDatabaseName());
    ...
    public Operation getOperation() {
        return Operation.CREATE_DATABASE;
    }
}
