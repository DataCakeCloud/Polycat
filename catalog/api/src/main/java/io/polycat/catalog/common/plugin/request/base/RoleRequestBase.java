...
@Data
public abstract class RoleRequestBase<T> extends ProjectRequestBase<T> {

    protected String roleName;

    public RoleRequestBase() {
    }

    public RoleRequestBase(String projectId, String roleName, T input) {
        super(projectId, input);
        this.roleName = roleName;
    }

    public CatalogInnerObject getCatalogObject(CatalogContext context) {
        return new CatalogInnerObject(projectId, null, null, roleName);
    }
}
