...
@Data
public class GetConstraintsRequest extends TableRequestBase<Void> {
    String type;

    public GetConstraintsRequest(String projectId, String catalogName, String databaseName, String tableName, String type) {
    ...
    public Operation getOperation() {
        return Operation.GET_CONSTRAINTS;
    }
}
