...
public class LongWritable extends Field {
    ...
    public boolean getBoolean() {
        ...
        if (value == 0) {
            ...
            throw new CarbonSqlException("LongWritable can't cast to boolean by value=" + value);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        LongWritable that = (LongWritable) o;
    ...
    public int compareTo(Field o) {
        return Long.compare(value, ((LongWritable) o).value);
    }
}
