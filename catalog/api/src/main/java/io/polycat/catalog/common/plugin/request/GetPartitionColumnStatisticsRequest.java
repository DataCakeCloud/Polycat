...
public class GetPartitionColumnStatisticsRequest extends TableRequestBase<GetPartitionColumnStaticsInput> {

    public GetPartitionColumnStatisticsRequest() {

    }

    public GetPartitionColumnStatisticsRequest(String projectId, String catalogName, String databaseName,
    ...
    public Map<String, String> getParams() {
        ...
        params.put(Constants.OPERATE_TYPE, "get");
        return params;
    }

    @Override
    public Operation getOperation() {
        return Operation.GET_PARTITION_COLUMN_STATISTICS;
    }
}
