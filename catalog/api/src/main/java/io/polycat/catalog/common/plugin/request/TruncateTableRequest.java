...
public class TruncateTableRequest extends TableRequestBase<Void> {

    // Params below is optional in the sql statement

    public TruncateTableRequest(String projectId, String catalogName, String databaseName, String tableName) {
    ...
    public Operation getOperation() {
        return Operation.TRUNCATE_TABLE;
    }
}
