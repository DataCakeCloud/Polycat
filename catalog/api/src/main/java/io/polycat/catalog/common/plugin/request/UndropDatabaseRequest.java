...
@Data
public class UndropDatabaseRequest extends DatabaseRequestBase<Void> {
    ...
    public Operation getOperation() {
        return Operation.UNDROP_DATABASE;
    }

    @Override
    public CatalogInnerObject getCatalogObject(CatalogContext context) {
        CatalogInnerObject catalogInnerObject = super.getCatalogObject(context);
