...
public class ListPartitionByFilterRequest extends TableRequestBase<PartitionFilterInput> {

    public ListPartitionByFilterRequest() {

    }

    public ListPartitionByFilterRequest(String projectId, String catalogName, String databaseName,
