...
@Data
public class DropPartitionsRequest extends TableRequestBase<DropPartitionsByExprsInput> {

    public DropPartitionsRequest() {
    }

    public DropPartitionsRequest(String projectId, String catalogName, String databaseName, String tableName,
        DropPartitionsByExprsInput input) {
        super(projectId, catalogName, databaseName, tableName, input);
    }

    public Map<String, String> getParams() {
        Map<String, String> params = new HashMap<>();
        params.put(Constants.OPERATE_TYPE, "dropPartitionsByExpr");
        return params;
    }

    @Override
    public Operation getOperation() {
        return Operation.DROP_PARTITIONS_BY_EXPR;
    }
}
