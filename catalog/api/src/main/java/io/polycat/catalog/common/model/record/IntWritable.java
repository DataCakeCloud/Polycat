...
public class IntWritable extends Field {
    ...
    public boolean getBoolean() {
        ...
        if (value == 0) {
            ...
            throw new CarbonSqlException("IntWritable can't cast to boolean by value=" + value);
        }
    }
    ...
    public int compareTo(Field o) {
        return Integer.compare(value, ((IntWritable) o).value);
    }
}
