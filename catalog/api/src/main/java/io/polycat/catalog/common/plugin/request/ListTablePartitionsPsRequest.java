...
public class ListTablePartitionsPsRequest extends TableRequestBase<PartitionFilterInput> {

    public ListTablePartitionsPsRequest() {

    }

    public ListTablePartitionsPsRequest(String projectId, String catalogName, String databaseName,
