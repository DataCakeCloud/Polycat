...
@Data
public class AlterFunctionRequest extends DatabaseRequestBase<FunctionInput> {
    String functionName;

    public AlterFunctionRequest(String projectId, String catalogName, String databaseName,
        FunctionInput input, String functionName) {
