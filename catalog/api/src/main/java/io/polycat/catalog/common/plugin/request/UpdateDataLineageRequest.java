...
@Data
public class UpdateDataLineageRequest extends ProjectRequestBase<LineageInfoInput> {
    public UpdateDataLineageRequest(String projectId, LineageInfoInput input) {
        super();
