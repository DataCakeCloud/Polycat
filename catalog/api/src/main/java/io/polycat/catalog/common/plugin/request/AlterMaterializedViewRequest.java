...
@Data
public class AlterMaterializedViewRequest extends DatabaseRequestBase<IndexRefreshInput> {

  private final String materializedViewName;

  public AlterMaterializedViewRequest(String projectId, String catalogName, String databaseName,
  ...
  public Operation getOperation() {
    return Operation.ALTER_MATERIALIZED_VIEW;
  }
}
