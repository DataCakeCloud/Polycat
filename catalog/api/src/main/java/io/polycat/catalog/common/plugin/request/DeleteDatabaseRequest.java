...
@Data
public class DeleteDatabaseRequest extends DatabaseRequestBase<DatabaseInput> {
    private Boolean ignoreUnknownObj = false;
    ...
    public DeleteDatabaseRequest(String projectId, String catName, String dbName) {
    ...
    public Operation getOperation() {
        return Operation.DROP_DATABASE;
    }
}
