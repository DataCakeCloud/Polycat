...
public class ListPartitionNamesPsRequest extends TableRequestBase<PartitionFilterInput> {

    public ListPartitionNamesPsRequest() {

    }

    public ListPartitionNamesPsRequest(String projectId, String catalogName, String databaseName,
