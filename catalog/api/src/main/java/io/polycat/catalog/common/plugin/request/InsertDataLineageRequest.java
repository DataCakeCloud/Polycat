...
@Data
public class InsertDataLineageRequest extends ProjectRequestBase<DataLineageInput> {
    public InsertDataLineageRequest(DataLineageInput accessLogInput) {
        super();
        this.input = accessLogInput;
    }
}
