...
@Data
@ApiModel(description = "common column stats data")
public class CommonColumnStatsData {
    @ApiModelProperty(value = "The number of null values in the column", required = true)
    protected long numNulls;

    @ApiModelProperty(value = "The number of distinct values in a column", required = true)
