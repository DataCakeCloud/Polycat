...
@Data
public class PrincipalPrivilegePolicy {
    public long policyUpdateTime;
    public List<MetaPrivilegePolicy> policyList;

    public PrincipalPrivilegePolicy(long updateTime, List<MetaPrivilegePolicy> policyList) {
