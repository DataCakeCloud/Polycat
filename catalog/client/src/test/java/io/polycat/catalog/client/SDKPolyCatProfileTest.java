...
import io.polycat.catalog.common.plugin.request.GetPolyCatProfileRequest;
...
public class SDKPolyCatProfileTest extends SDKTestUtil{
    ...
    public void collectDatabaseAndTableTest() {
        ...
        GetPolyCatProfileRequest request = new GetPolyCatProfileRequest(ACCOUNT_ID, PROJECT_ID);
        PolyCatProfile polyCatProfile = client.getPolyCatProfile(request);
        long tableCount = 0;
        long databaseCount = 0;
        for (UserProfileContext userProfileContext : polyCatProfile.getUserProfileContexts()) {
