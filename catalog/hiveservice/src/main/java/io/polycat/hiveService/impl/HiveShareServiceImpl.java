...
public class HiveShareServiceImpl implements ShareService {
    ...
    public void addPrivilegeToShare(String projectId, String shareName, ShareInput shareInput) {
        throw new CatalogServerException(ErrorCode.FEATURE_NOT_SUPPORT, "addPrivilegeToShare");
    }

    @Override
    public void removePrivilegeFromShare(String projectId, String shareName, ShareInput shareInput) {
        throw new CatalogServerException(ErrorCode.FEATURE_NOT_SUPPORT, "removePrivilegeFromShare");
    }
