...
public interface TableDataStore {
    ...
    void insertTableHistory(TransactionContext context, TableIdent tableIdent, String version, TableHistoryObject tableHistory);
    ...
    List<String> listTablePartitionNames(TransactionContext context, TableIdent tableIdent,  Integer maxParts);
    ...
    void insertDataPartitionSet(TransactionContext context, TableIdent tableIdent, DataPartitionSetObject dataPartitionSetObject);
    ...
    void insertPartitionInfo(TransactionContext context, TableIdent tableIdent, DataPartitionSetObject dataPartitionSetObject);

    DataPartitionSetObject getDataPartitionSet(TransactionContext context, TableIdent tableIdent, String setId);

    void updateDataPartitionSet(TransactionContext context, TableIdent tableIdent, DataPartitionSetObject dataPartitionSetObject);

    void insertIndexPartitionSet(TransactionContext context, TableIdent tableIdent, IndexPartitionSetObject indexPartitionSetObject);

    IndexPartitionSetObject getIndexPartitionSet(TransactionContext context, TableIdent tableIdent, String setId);

    void updateIndexPartitionSet(TransactionContext context, TableIdent tableIdent, IndexPartitionSetObject indexPartitionSetObject);
