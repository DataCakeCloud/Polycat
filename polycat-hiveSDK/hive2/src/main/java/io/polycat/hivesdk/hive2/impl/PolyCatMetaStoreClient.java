 ...
 */
package io.polycat.hivesdk.hive2.impl;

import static io.polycat.hivesdk.hive2.config.ConfigKeyContents.AUTH_SOURCE_TYPE;
import static io.polycat.hivesdk.hive2.config.ConfigKeyContents.CATALOG_HOST;
import static io.polycat.hivesdk.hive2.config.ConfigKeyContents.CATALOG_PORT;
import static io.polycat.hivesdk.hive2.config.ConfigKeyContents.DEFAULT_CATALOG_NAME;
import static io.polycat.hivesdk.hive2.config.ConfigKeyContents.POLYCAT_USER_NAME;
import static io.polycat.hivesdk.hive2.config.ConfigKeyContents.POLYCAT_USER_PASSWORD;
...
import io.polycat.hivesdk.hive2.config.HiveCatalogContext;
import io.polycat.hivesdk.hive2.tools.HiveClientHelper;
...
public class PolyCatMetaStoreClient implements IMetaStoreClient {
    ...
    public org.apache.hadoop.hive.metastore.api.Partition appendPartition(String catName, String dbName,
        ...
        String partName = LsmDataAccessor.getPartitionName(partVals, table);
    ...
    public org.apache.hadoop.hive.metastore.api.Partition add_partition(
        ...
        AddPartitionRequest request = new AddPartitionRequest(context.getProjectId(),
            ...
            LsmDataAccessor.toPartitionInput(partition, context.getDefaultCatalogName()));
    ...
    public List<org.apache.hadoop.hive.metastore.api.Partition> add_partitions(
        ...
        String catName = context.getDefaultCatalogName();
        boolean ifEveryPartitionNotInSameTable = partitions.stream().
            anyMatch(part -> !Objects.equals(part.getDbName(), hivePart.getDbName())
        ...
        AddPartitionInput input = LsmDataAccessor.toPartitionInput(partitions, context.getDefaultCatalogName());
    ...
    public void createTable(Table table)
        ...
        request.setProjectId(context.getProjectId());
        request.setCatalogName(context.getDefaultCatalogName());
        request.setDatabaseName(table.getDbName());
        request.setInput(LsmDataAccessor.toTableInput(table, context.getDefaultCatalogName()));
    ...
    public void alter_table(String catName, String dbName, String tblName, Table newTable,
        ...
        AlterTableInput alterTableInput =
            new AlterTableInput(LsmDataAccessor.toTableInput(newTable, context.getDefaultCatalogName()), LsmDataAccessor.toAlterTableParams(envContext));
    ...
    public void createDatabase(Database database)
        throws InvalidObjectException, AlreadyExistsException, MetaException, TException {
        DatabaseInput input = LsmDataAccessor.toDatabaseInput(database, context.getCatalogContext());
    ...
    public void alterDatabase(String catName, String dbName, Database newDb)
        throws NoSuchObjectException, MetaException, TException {
        DatabaseInput input = LsmDataAccessor.toDatabaseInput(newDb, context.getCatalogContext());
    ...
    @Override
    public List<org.apache.hadoop.hive.metastore.api.Partition> dropPartitions(String dbName, String tblName,
            List<ObjectPair<Integer, byte[]>> partExprs, boolean deleteData, boolean ifExists, boolean needResults)
            throws NoSuchObjectException, MetaException, TException {
        return null;
    }
    ...
    public boolean dropPartition(String catName, String db_name, String tbl_name, List<String> part_vals,
        ...
        String partName = LsmDataAccessor.getPartitionName(part_vals, table);
    ...
    public List<org.apache.hadoop.hive.metastore.api.Partition> dropPartitions(String catName, String dbName,
        ...
        PartitionDropOptions options) throws NoSuchObjectException, MetaException, TException {
        List<Pair<Integer, byte[]>> exprs = LsmDataAccessor.toPartitonExprs(partExprs);
    ...
    public void alter_partitions(String catName, String dbName, String tblName,
        ...
        PartitionAlterContext[] ctxs = newParts.stream().map(LsmDataAccessor::toPartitionAlterContext)
    ...
    public void renamePartition(String catName, String dbname, String tableName, List<String> part_vals,
        ...
        ctxs[0] = LsmDataAccessor.toPartitionAlterContext(newPart);
    ...
    public boolean updateTableColumnStatistics(ColumnStatistics columnStatistics)
        ...
        UpdateTableColumnStatisticRequest request = new UpdateTableColumnStatisticRequest(context.getProjectId(),
                context.getDefaultCatalogName(), desc.getDbName(), desc.getTableName(),
                LsmDataAccessor.toColumnStatistics(columnStatistics, context.getDefaultCatalogName()));
        return HiveClientHelper.FuncExceptionHandler(() -> {
    ...
    public boolean updatePartitionColumnStatistics(ColumnStatistics columnStatistics)
        throws NoSuchObjectException, InvalidObjectException, MetaException, TException, InvalidInputException {
        ColumnStatisticsDesc desc = columnStatistics.getStatsDesc();
        ColumnStatisticsInput input = new ColumnStatisticsInput(LsmDataAccessor.toColumnStatistics(columnStatistics, context.getDefaultCatalogName()));
        UpdatePartitionColumnStatisticRequest request = new UpdatePartitionColumnStatisticRequest(
            context.getProjectId(),
                context.getDefaultCatalogName(), desc.getDbName(), desc.getTableName(), input);
        return HiveClientHelper.FuncExceptionHandler(() -> {
    ...
    public void createFunction(Function function) throws InvalidObjectException, MetaException, TException {
        ...
        CreateFunctionRequest request = new CreateFunctionRequest(context.getProjectId(),
                context.getDefaultCatalogName(),
            LsmDataAccessor.toFunctionInput(function, context.getDefaultCatalogName()));
    ...
    public void alterFunction(String catName, String dbName, String funcName, Function newFunction)
        ...
        AlterFunctionRequest request = new AlterFunctionRequest(context.getProjectId(),
            catName,
            dbName,
            LsmDataAccessor.toFunctionInput(newFunction, context.getDefaultCatalogName()),
            funcName);
        HiveClientHelper.FuncExceptionHandler(() -> {
    ...
    private SetPartitionColumnStatisticsInput generateSetPartStatsInput(SetPartitionsStatsRequest hiveRequest)
        ...
        for (ColumnStatistics hiveStats : hiveStatsList) {
            lsmStatsList.add(LsmDataAccessor.toColumnStatistics(hiveStats, context.getDefaultCatalogName()));
        }
    ...
    public void addPrimaryKey(List<SQLPrimaryKey> primaryKeyCols)
        ...
        if (primaryKeyCols != null && !primaryKeyCols.isEmpty()) {
            ...
            List<PrimaryKey> lsmKeyCols =
                primaryKeyCols.stream().map(LsmDataAccessor::toPrimaryKey).peek(x->x.setCatName(context.getDefaultCatalogName())).collect(Collectors.toList());
    ...
    public void addForeignKey(List<SQLForeignKey> foreignKeyCols)
        ...
        if (foreignKeyCols != null && !foreignKeyCols.isEmpty()) {
            ...
            List<ForeignKey> lsmKeyCols =
                foreignKeyCols.stream().map(LsmDataAccessor::toForeignKey).peek(x -> x.setCatName(context.getDefaultCatalogName())).collect(Collectors.toList());
