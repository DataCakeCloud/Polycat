...
public class LsmDataAccessor {
    ...
    private static Object convertToDecimalData(Object statsData) throws TException {
        ...
        polyCatDecimalData.setBitVectors(DataTypeUtil.getBitVectors(hiveDecimalData.getBitVectors()));
    ...
    public static ColumnStatistics toColumnStatistics(org.apache.hadoop.hive.metastore.api.ColumnStatistics hiveStats, String catalogName)
        throws TException {
        org.apache.hadoop.hive.metastore.api.ColumnStatisticsDesc hiveDesc = hiveStats.getStatsDesc();
        ColumnStatisticsDesc lsmDesc = new ColumnStatisticsDesc(hiveDesc.isIsTblLevel(), catalogName,
    ...
    public static DatabaseInput toDatabaseInput(Database database, CatalogContext context) {
        ...
        databaseInput.setCatalogName(context.getDefaultCatalogName());
    ...
    public static TableInput toTableInput(Table table, String catalogName) {
    ...
    // partition
    private static PartitionInput convertToPartitionBaseInputPartial(Partition hivePartition, String catalogName) {
        ...
        lsmPartition.setCatalogName(catalogName);
    ...
    public static AddPartitionInput toPartitionInput(Partition partition, String catalogName) {
        AddPartitionInput partInput = new AddPartitionInput();
        PartitionInput baseInput = convertToPartitionBaseInputPartial(partition, catalogName);
    ...
    public static AddPartitionInput toPartitionInput(List<Partition> partitions, String catalogName) {
        AddPartitionInput partInput = new AddPartitionInput();
        int partSize = partitions.size();
        PartitionInput[] baseInputs = new PartitionInput[partSize];
        for (int i = 0; i < partSize; i++) {
            baseInputs[i] = convertToPartitionBaseInputPartial(partitions.get(i), catalogName);
        }
        partInput.setOverwrite(false);
        partInput.setBasedVersion(null);
        partInput.setFileFormat(null);
    ...
    public static FunctionInput toFunctionInput(Function hiveFunc, String catalogName) {
