 ...
 */
package io.polycat.hivesdk.hiveOriginalTest.client;
...
import io.polycat.hivesdk.PolyCatTestUtils;
import io.polycat.hivesdk.MetaStoreTestUtils;
import io.polycat.hivesdk.hiveOriginalTest.annotation.MetastoreCheckinTest;
import io.polycat.hivesdk.hiveOriginalTest.minihms.AbstractMetaStoreService;
...
public class TestAlterPartitions extends MetaStoreClientTest {
  ...
  public static final String CATALOG_NAME = "alter_partition_catalog";
  ...
  public static void setUp() throws Exception {
    ...
    for (String dbNames : client.getAllDatabases()) {
      if (dbNames.equals("default")) {
        continue;
      }
      client.dropDatabase(dbNames, true, true, true);
    }
    for (String tableName : client.getAllTables("default")) {
      client.dropTable("default", tableName, false, true, false);
    }
  }
   ...
   */
  @Ignore("column alter not support yet")
  @Test
  ...
  @Ignore("we should read partition first and modify the partition")
  ...
  @Ignore("alter table find partition first and throw exception")
  @Test(expected = InvalidOperationException.class)
  ...
  @Ignore("client should check db cant modified")
  @Test(expected = MetaException.class)
  ...
  @Ignore("client should check table cant modified")
  @Test(expected = MetaException.class)
   ...
   */
  @Ignore("not support alter partition columns")
  @Test
  ...
  @Ignore("dbName changed not check")
  @Test(expected = MetaException.class)
  ...
  @Ignore("alter find partition first, throw not found exception")
  @Test(expected = InvalidOperationException.class)
  ...
  @Ignore("not check partition catalog should ")
  @Test(expected = InvalidOperationException.class)
  ...
  @Ignore("alter partition should check db name")
  @Test(expected = MetaException.class)
  ...
  @Ignore("alter partition should check tbl name")
  @Test(expected = MetaException.class)
  ...
  @Ignore("client find table first and throw not found exception")
  @Test(expected = InvalidOperationException.class)
  ...
  @Ignore("client not check dbname changed")
  @Test(expected = MetaException.class)
  ...
  @Ignore("client not check tableName changed")
  @Test(expected = MetaException.class)
...
//    assertEquals(3, newParts.get(3).getSd().getCols().size());
  ...
  @Ignore("client not check tblName in partition")
  @Test(expected = MetaException.class)
  ...
  @Ignore("dbName in partiton not check")
  @Test(expected = MetaException.class)
  ...
  @Ignore("polycat need translate key first, throw exception")
  @Test(expected = InvalidOperationException.class)
  ...
  @Ignore("partVals is null not check")
  @Test(expected = InvalidOperationException.class)
  ...
  @Ignore("alter table not support change tbl")
  @Test(expected = MetaException.class)
  ...
  @Ignore("alter table not support change db")
  @Test(expected = MetaException.class)
