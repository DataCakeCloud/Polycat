...
public class TestAppendPartitions extends MetaStoreClientTest {
  ...
  @Ignore("we find partition first and throw not found")
  ...
  @Ignore("polyCat found table first ,and return notFound")
  @Test(expected = InvalidObjectException.class)
  ...
  @Ignore("catalog search partition first")
  @Test(expected = InvalidObjectException.class)
