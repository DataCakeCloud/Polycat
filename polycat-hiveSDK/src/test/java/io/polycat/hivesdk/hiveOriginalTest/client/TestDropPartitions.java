...
public class TestDropPartitions extends MetaStoreClientTest {
  ...
  @Ignore("partition values trans to name first, and used default name")
  @Test(expected = MetaException.class)
  ...
  @Ignore("not support trash, not config test")
  @Test
