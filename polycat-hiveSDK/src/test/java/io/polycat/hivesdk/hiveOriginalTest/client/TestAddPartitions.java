...
public class TestAddPartitions extends MetaStoreClientTest {
  ...
  public static final String CATALOG_NAME = "add_partition_catalog";
  ...
  public void setUp() throws Exception {
    ...
    for (String tableName : client.getAllTables("default")) {
      client.dropTable("default", tableName, true, true, true);
    }
  ...
  @Ignore("the exception is different. Because polycat query table first and throw not found exception")
  ...
  @Ignore("polycat get table and throw not found exception")
  @Test(expected = InvalidObjectException.class)
  ...
  @Ignore("hive not throw exception")
  @Test(expected = MetaException.class)
  ...
  @Ignore("Should check the added partitions in same table")
  @Test(expected = MetaException.class)
  ...
  @Ignore("polycat get table first and throw not found exception")
  @Test(expected = MetaException.class)
  ...
  @Ignore("client should check partitions has same tableName")
  @Test(expected = MetaException.class)
  ...
  @Ignore("not check tableName is null")
  @Test(expected = MetaException.class)
...
//    Assert.assertFalse(metaStore.isPathExists(new Path(tableLocation + "/year=2017")));
  ...
  @Ignore("Exception not same, need check")
  @Test(expected = MetaException.class)
  ...
  @Ignore("need return null but return empty List")
  @Test
  ...
  @Ignore("Null Pointers and empty lists need to be handled separately")
  @Test
  ...
  @Ignore("not check serde is null")
  @Test(expected = MetaException.class)
  ...
  @Ignore("client should check partition in same tbl")
  @Test(expected = MetaException.class)
  ...
  @Ignore("should check add partitions is in same db")
  @Test
