...
public class HiveDataAccessor {
    ...
    private static DecimalColumnStatsData convertToHiveDecimalStatsInner(Object dataValue) {
        ...
        decimalData.setHighValue(
            new Decimal(polyCatDecimalData.getHighValue().getScale(), polyCatDecimalData.getHighValue().getUnscaled()));
        decimalData.setLowValue(
            new Decimal(polyCatDecimalData.getLowValue().getScale(), polyCatDecimalData.getLowValue().getUnscaled()));
    ...
    public static org.apache.hadoop.hive.metastore.api.Database toDatabase(Database polyCatDatabase) {
        ...
        database.setOwnerType(PrincipalType.valueOf(polyCatDatabase.getOwnerType()));
        return database;
    }

    public static Catalog toCatalog(io.polycat.catalog.common.model.Catalog catalog) throws MetaException {
        return new CatalogBuilder()
            .setName(catalog.getCatalogName())
            .setDescription(catalog.getDescription())
            .setLocation(catalog.getLocation())
            .build();
    }
    ...
    public static Table toTable(io.polycat.catalog.common.model.Table lsmTbl) {
        ...
        table.setOwnerType(getOwnerTypeStruct(lsmTbl.getOwnerType()));
    ...
    public static org.apache.hadoop.hive.metastore.api.Partition toPartition(Partition partition, String catName,
        ...
        org.apache.hadoop.hive.metastore.api.StorageDescriptor partitionSd = new org.apache.hadoop.hive.metastore.api.StorageDescriptor();
