...
public class PolyCatFailureAwareThriftMetastoreClient
    ...
    @Override
    public void alterTableWithEnvironmentContext(String databaseName, String tableName, Table newTable,
        EnvironmentContext context) throws TException {
        log.debug("[DEBUG-INFO] alterTableWithEnvironmentContext");
        runWithHandle(() -> delegate.alter_table_with_environmentContext(databaseName, tableName, newTable, context));
    }
...
//    }
    ...
    public void updateTableWriteId(String dbName, String tableName, long transactionId, long writeId,
        OptionalLong rowCountChange) throws TException {
        log.debug("[DEBUG-INFO] updateTableWriteId");
    }

    @Override
    public void alterPartitions(String dbName, String tableName, List<Partition> partitions, long writeId)
        throws TException {
        log.debug("[DEBUG-INFO] alterPartitions");
    }

    @Override
    public void addDynamicPartitions(String dbName, String tableName, List<String> partitionNames, long transactionId,
        long writeId, AcidOperation operation) throws TException {
        log.debug("[DEBUG-INFO] addDynamicPartitions");
    }

    @Override
    public void alterTransactionalTable(Table table, long transactionId, long writeId, EnvironmentContext context)
        throws TException {
        log.debug("[DEBUG-INFO] alterTransactionalTable");
    }
