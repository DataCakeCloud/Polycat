...
public class DatabaseMigration extends BaseMigration implements Serializable {

    public DatabaseMigration(Migration migration, List<MigrationItem> items, JavaSparkContext jsc) {
    ...
    public List<MigrationItem> run() {
        ...
        List<MigrationItem> collect = rdd.mapPartitions(new FlatMapFunction<Iterator<MigrationItem>, MigrationItem>() {
            @Override
            public Iterator<MigrationItem> call(Iterator<MigrationItem> itemsIterator) throws Exception {
                ...
                while (itemsIterator.hasNext()) {
                    MigrationItem item = itemsIterator.next();
