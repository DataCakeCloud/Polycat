...
public class HiveUsageProfileExtracter
    ...
    public HiveUsageProfileExtracter(Configuration conf, String catalogName, String defaultDbName) {
        this.conf = conf;
        this.catalogName = catalogName;
        this.defaultDbName = defaultDbName;
    }

    public HiveUsageProfileExtracter(
    ...
    public List<TableUsageProfile> extractTableUsageProfile(
        ...
        return PolyCatClientUtil.createTableUsageProfileByOperationObjects(
                catalogName, defaultDbName, command, conf, tablesOperation);
    }
}
